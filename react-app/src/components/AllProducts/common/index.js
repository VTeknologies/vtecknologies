  ...
  return (
    ...
    >
      ...
      <div className="mt-9 flex justify-center place-content-between  items-center">
        ...
        {name==="Twilio"?<div className="w-4/5" id="twilioimg">
  ...
  <section className="my-4 pb-10">
    {installationpprocedures.map((x, index) => (
      <p className="mt-4" key={index}>
        {x.startsWith("1.") || x.startsWith("2.") || x.startsWith("3.") || x.startsWith("4.") || x.startsWith("5.") || x.startsWith("6.") || x.startsWith("7.") ? (
          <b>{x}</b>
        ) : (
          ...
          <>
            {x.includes("https://") ? (
              ...
              <span className={`ml-${x.startsWith("        ") ? "6" : ""}`}>{x}</span>
            )}
          </>
        )}
      </p>
